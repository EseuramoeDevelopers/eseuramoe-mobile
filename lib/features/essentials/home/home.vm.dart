...
class HomeVM extends GetxController {
  ...
  void requestInit() async {
   ...
   resultCount.value = formatValue(await StorageService("dashboard_data").get("result_count") ?? 0);
    modelCount.value = formatValue(await StorageService("dashboard_data").get("model_count") ?? 0);
    detectedCount.value = formatValue(await StorageService("dashboard_data").get("detected_count") ?? 0);
